...
import { addTODO, clearFlags, filterByPriority, filterByStatus, prioritiseTODO, markTODO, getTODOS } from '../store/Actions/actionCreator';
...
const TODO = ({todos, forbiddenFlag, addTODOR, theme,
    ...
    return (
        <div>
            <div className="d-none d-sm-none d-md-block w-100 darkColor m-0 ">
                ...
                <div className='w-100 todosCover' style={{minHeight: '80vh'}}>
                        <div className="w-75 border  p-3 mx-auto mt-4 float-left" style={{maxHeight: '70vh', height: '70vh'}}>
                            <h2>Liste des TODO : </h2>
                            {
                                todos.map(
                                    todo => todo !== undefined ? 
                                    <div key={todo.id} className={getClass(todo)}>
                        ...
                        <Form className="w-25 border border-muted text-dark p-5 mx-auto mt-4 float-right">
                            <FormGroup row>
