...
import {armesManager} from './service/core';
...
let armesMgr : (armesManager | undefined) = undefined;
...
const PriseArmes = ({session, listPers, priseArmes, priseArmesEtablie, priseArmesEcrite, setRoute, listdu, getPriseArmes, setPriseArmes}) => {
    ...
    {
        getPriseArmes()
        armesMgr = new armesManager(listPers);
    }
    ...
    useEffect(
        () => {
            ...
            {
                setRoute('/prisearmes') // todo set future prise armes editor page
            }
        }
        , [priseArmesEcrite, priseArmesEtablie]
    )
        ...
        <div className="d-flex w-100 h-100 armesCover" style={{color: "#012121"}}>
            ...
            <div className="maindPers w-100" style={{paddingTop: '20px'}}>
                ...
                <div className='float-left bg-secondary w-100 m-3 p-1 rounded'>
                    <h3 className=''>⚔️ PREMIERE CONFIGURATION DE LA LISTE DE PRISE ARMES</h3>
                    <h5>
